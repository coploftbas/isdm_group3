...
class PrerequisitesControllerTest < ActionController::TestCase
  ...
  test "should create prerequisite" do
    assert_difference('Prerequisite.count') do
      post :create, prerequisite: { document_id_id: @prerequisite.document_id_id, prerequisite_id_id: @prerequisite.prerequisite_id_id }
    end
  ...
  test "should update prerequisite" do
    patch :update, id: @prerequisite, prerequisite: { document_id_id: @prerequisite.document_id_id, prerequisite_id_id: @prerequisite.prerequisite_id_id }
    assert_redirected_to prerequisite_path(assigns(:prerequisite))
  end
