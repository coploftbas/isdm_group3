...
class ProjectUserRolesControllerTest < ActionController::TestCase
  ...
  test "should create project_user_role" do
    assert_difference('ProjectUserRole.count') do
      post :create, project_user_role: { project_id: @project_user_role.project_id, role_id: @project_user_role.role_id, user_id: @project_user_role.user_id }
    end
  ...
  test "should update project_user_role" do
    patch :update, id: @project_user_role, project_user_role: { project_id: @project_user_role.project_id, role_id: @project_user_role.role_id, user_id: @project_user_role.user_id }
    assert_redirected_to project_user_role_path(assigns(:project_user_role))
  end
