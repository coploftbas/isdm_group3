...
class DocumentVersionsControllerTest < ActionController::TestCase
  ...
  test "should create document_version" do
    assert_difference('DocumentVersion.count') do
      post :create, document_version: { comment: @document_version.comment, created_by: @document_version.created_by, document_id: @document_version.document_id, document_name: @document_version.document_name, file_location: @document_version.file_location, updated_by: @document_version.updated_by, version_document_name: @document_version.version_document_name }
    end
  ...
  test "should update document_version" do
    patch :update, id: @document_version, document_version: { comment: @document_version.comment, created_by: @document_version.created_by, document_id: @document_version.document_id, document_name: @document_version.document_name, file_location: @document_version.file_location, updated_by: @document_version.updated_by, version_document_name: @document_version.version_document_name }
    assert_redirected_to document_version_path(assigns(:document_version))
  end
